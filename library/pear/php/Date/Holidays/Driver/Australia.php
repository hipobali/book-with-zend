...
class Date_Holidays_Driver_Australia extends Date_Holidays_Driver
{
    ...
    function _buildHolidays()
    {
        ...
        $this->_addHoliday('australia_newYearsDay', $newYearsDay, 'New Year\'s Day');
        $this->_addTranslationForHoliday('australia_newYearsDay', 'en_EN', 'New Year\'s Day');
        ...
        $this->_addHoliday('australia_australiaDay', $australiaDay, 'Australia Day');
        $this->_addTranslationForHoliday('australia_australiaDay', 'en_EN', 'Australia Day');
        /*
         * Easter
         */
        ...
        if ($easterMonday->format('d') == 25) {
            $this->_addHoliday('australia_easterTuesday', $this->_addDays($easterMonday, 1), 'Easter Tuesday');
            $this->_addTranslationForHoliday('australia_easterTuesday', 'en_EN', 'Easter Tuesday');
        }

        $this->_addHoliday('australia_goodFriday', $goodFridayDate, 'Good Friday');
        $this->_addHoliday('australia_easterMonday', $easterMonday, 'Easter Monday');
        $this->_addTranslationForHoliday('australia_goodFriday', 'en_EN', 'Good Friday');
        $this->_addTranslationForHoliday('australia_easterMonday', 'en_EN', 'Easter Monday');
        ...
        $this->_addHoliday('australia_anzacDay', $anzacDay, 'Anzac Day');
        $this->_addTranslationForHoliday('australia_anzacDay', 'en_EN', "Anzac Day");
        if ($anzacDay->format('w') == 0) { // 0 = Sunday
            $anzacDayHol = $this->_year . '-04-26';
            $this->_addHoliday('australia_anzacDay', $anzacDayHol, 'Anzac Day Holiday');
        ...
        $this->_addHoliday('australia_queensBirthday', $queensBirthday, "Queen's Birthday");
        $this->_addTranslationForHoliday('australia_queensBirthday', 'en_EN', "Queen's Birthday");
        ...
        if ($christmasDay->format('w') == 6) {
            ...
            $this->_addHoliday('australia_christmasDay',
                               $this->_year . '-12-27',
            ...
            $this->_addHoliday('australia_christmasDay', $christmasDay, 'Christmas Day');
        }
        ...
        if ($boxingDay->format('w') == 6) {
            ...
            $this->_addHoliday('australia_boxingDay',
                               $this->_year . '-12-28',
            ...
            $this->_addHoliday('australia_boxingDay', $this->_year . '-12-26', 'Boxing Day');
        }

        $this->_addTranslationForHoliday('australia_christmasDay', 'en_EN', 'Christmas Day');
        $this->_addTranslationForHoliday('australia_boxingDay', 'en_EN', 'Boxing Day');
