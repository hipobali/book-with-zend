...
class Date_Holidays_Driver_Austria extends Date_Holidays_Driver
{
    ...
    function _buildHolidays()
    {
         ...
         * New Year's Day
         */
        $this->_addHoliday('austria_newYearsDay', $this->_year . '-01-01', 'Neujahr');
        $this->_addTranslationForHoliday('austria_newYearsDay', 'en_EN', 'New Year\'s Day');
        ...
        $this->_addTranslationForHoliday('austria_epiphany', 'en_EN', 'Epiphany');

        /**
         * Valentine´s Day
         */
        $this->_addHoliday(
            'austria_valentinesDay',
            $this->_year . '-02-14',
            'Valentinstag'
        );
        $this->_addTranslationForHoliday('austria_valentinesDay', 'en_EN', 'Valentines Day');

        /**
         * Easter Sunday
         */
        $easterDate = Date_Holidays_Driver_Christian::calcEaster($this->_year);
        $this->_addHoliday('austria_easter', $easterDate, 'Ostersonntag');
        $this->_addTranslationForHoliday('austria_easter', 'en_EN', 'Easter');

        /**
         * Ash Wednesday
         */
        $ashWednesday = $this->_addDays($easterDate, -46);
        $this->_addHoliday('austria_ashWednesday', $ashWednesday, 'Aschermittwoch');
        $this->_addTranslationForHoliday('austria_ashWednesday', 'en_EN', 'Ash Wednesday');

        /**
         * Palm Sunday
         */
        $palmSunday = $this->_addDays($easterDate, -7);
        $this->_addHoliday('austria_palmSunday', $palmSunday, 'Palmsonntag');
        $this->_addTranslationForHoliday('austria_palmSunday', 'en_EN', 'Palm Sunday');

        /**
         * Maundy Thursday
         */
        $maundyThursday = $this->_addDays($easterDate, -3);
        $this->_addHoliday('austria_maundyThursday', $maundyThursday, 'Gründonnerstag');
        $this->_addTranslationForHoliday(
            'austria_maundyThursday',
            'en_EN',
            'Maundy Thursday'
        );
        ...
        $this->_addHoliday('austria_goodFriday', $goodFriday, 'Karfreitag');
        $this->_addTranslationForHoliday('austria_goodFriday', 'en_EN', 'Good Friday');

        /**
         * Easter Monday
         */
        $easterMonday = $this->_addDays($easterDate, 1);
        $this->_addHoliday('austria_easterMonday', $easterMonday, 'Ostermontag');
        $this->_addTranslationForHoliday('austria_easterMonday', 'en_EN', 'Easter Monday');

        /**
         * Day of Work
         */
        $this->_addHoliday(
            'austria_dayOfWork', $this->_year . '-05-01',
            'Staatsfeiertag Österreich'
        );
        $this->_addTranslationForHoliday('austria_dayOfWork', 'en_EN', 'Day of Work');

        /**
         * Saint Florian
         */
        $this->_addHoliday('austria_saintFlorian', $this->_year . '-05-04', 'St. Florian');
        $this->_addTranslationForHoliday('austria_saintFlorian', 'en_EN', 'St. Florian');
       ...
       // $mothersDay = $mothersDay->sub( new DateInterval('P1D'));
        ...
        $this->_addHoliday('austria_mothersDay', $mothersDay, 'Muttertag');
        $this->_addTranslationForHoliday('austria_mothersDay', 'en_EN', 'Mothers Day');

        /**
         * Ascension Day
         */
        $ascensionDate = $this->_addDays($easterDate, 39);
        $this->_addHoliday('austria_ascensionDate', $ascensionDate, 'Christi Himmelfahrt');
        $this->_addTranslationForHoliday('austria_ascensionDate', 'en_EN', 'Ascension Day');
        ...
        $this->_addHoliday('austria_whitsun', $whitsunDate, 'Pfingstsonntag');
        $this->_addTranslationForHoliday('austria_whitsun', 'en_EN', 'Whitsun');
