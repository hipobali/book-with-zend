...
class Date_Holidays_Filter_Iceland_Official extends Date_Holidays_Filter_Whitelist
{
    ...
    {
        parent::__construct(array('iceland_newYearsDay',
                                  'iceland_maundyThursday',
                                  'iceland_goodFriday',
                                  'iceland_easterMonday',
                                  'iceland_whitMonday',
                                  'iceland_ascensionDay',
                                  'iceland_mayDay',
                                  'iceland_nationalDay',
                                  'iceland_commerceDay',
                                  'iceland_christmas',
                                  'iceland_christmasDay',
                                  'iceland_secondChristmasDay',
                                  'iceland_newYearsEve'));
    }
