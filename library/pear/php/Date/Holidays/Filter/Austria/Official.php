...
class Date_Holidays_Filter_Austria_Official extends Date_Holidays_Filter_Whitelist
{
    ...
    {
        parent::__construct(array('austria_newYearsDay',
                                  'austria_epiphany',
                                  'austria_easterMonday',
                                  'austria_dayOfWork',
                                  'austria_ascensionDate',
                                  'austria_whitMonday',
                                  'austria_corpusChristi',
                                  'austria_mariaAscension',
                                  'austria_nationalDayAustria',
                                  'austria_allSaintsDay',
                                  'austria_immaculateConceptionDay',
                                  'austria_christmasDay',
                                  'austria_boxingDay'));
    }
